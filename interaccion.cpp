...
interaccion::interaccion() {
	arregloEmpleados = nullptr;
	cantidadEmpleados = 0;
}

interaccion::interaccion(int numEmpleados) {
	arregloEmpleados = new empleado[numEmpleados];
	cantidadEmpleados = numEmpleados;
}


void interaccion::generacionEmpleados(int numEmpleadosAux)
{
...
void interaccion::modificarEmpleado(empleado arrayEmpleados[])
{
	char[20] cedulaAux;
...
void interaccion::imprimirEmpleados(empleado arrayEmpleados[])
{
	int arrayTamano = sizeof(arrayEmpleados) / sizeof(arrayEmpleados[0]);
...
void interaccion::pagarEmpleados(empleado arrayEmpleados[])
{
	int arrayTamano = sizeof(arrayEmpleados) / sizeof(arrayEmpleados[0]);
...
void interaccion::obtenerAguinaldo(empleado arrayEmpleados[])
{
	char[20] cedulaAux;
